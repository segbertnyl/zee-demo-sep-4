...
const STORY_ID = 'ui-backgrounds-plan-summary--default'

test.describe('PlanSummaryBackground', () => {
  ...
  test('visual snapshot', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('plan-summary-background--default.png')
  })
})
