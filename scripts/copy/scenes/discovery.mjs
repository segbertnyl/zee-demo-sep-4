...
export function rows() {
  ...
  out.push(
    dAdd(
      ...
      'Nyla Introduction',
      'headline',
      "Hi, Sarah. I'm Nyla. Let's build a plan for your practice, your way.",
      'discovery.intro.headline',
      '816-25664',
      'advisorName',
    ),
  )
  out.push(
    dAdd(
      ...
      'Nyla Introduction',
      'body',
      "Every agent is different, and I want to hear what makes your style your own. As we go through this, keep in mind: the plan is always changeable. Let's get to know you.",
      'discovery.intro.body',
      '816-25664',
    ),
  )

  out.push(
    dAdd('Discovery', 'Plan Reveal', 'loading', 'Great, sounds like', 'discovery.plan-reveal.prefix', '922-3415'),
  )
