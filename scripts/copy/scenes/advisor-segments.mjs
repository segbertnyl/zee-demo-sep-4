...
const SEGMENTS = [
  ...
  },
  {
    ...
    growthAreas: [
      ...
      {
        id: 'conversations',
        label: 'Starting and handling client conversations',
        sub: 'Discovery, objections, closing',
      },
    ...
    conciergeSlows: [
      ...
      {
        id: 'income',
        label: 'Understanding what my income actually looks like',
        sub: 'Commission timing, chargebacks',
      },
    ],
    conciergeTimeSuggestions: [
