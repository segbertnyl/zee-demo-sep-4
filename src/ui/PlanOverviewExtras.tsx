...
const PLAN_GOALS: SummaryItem[] = [
  {
    ...
    description:
      "Based on your current pace and last year's performance, hitting $175K in FYC is an achievable target.",
  },
  {
    icon: <CouncilIcon />,
    title: "Reach President's Council",
    description:
      "You've been close for two years running. This year's plan prioritizes the case volume and mix needed to qualify.",
  },
  {
    icon: <GrowthIcon />,
    title: 'Become a holistic accumulation leaning advisor',
    description:
      'You want to move beyond pure protection into a full financial planning practice. This shapes how we prioritize your book.',
  },
  {
    icon: <SuccessionIcon />,
    title: 'Take on clients from a retiring agent',
    description:
      "You flagged interest in acquiring a retiring colleague's book. We've built outreach and onboarding steps into your plan.",
  },
  {
    icon: <NetworkIcon />,
    title: 'Expand your network of communities',
    description:
      'Growing your referral network through community engagement is a high-leverage activity we build regular time for.',
  },
  {
    icon: <ProtectIcon />,
    title: 'Protect time outside of work',
    description:
      'Work has been bleeding into personal time. Setting hard boundaries is part of building a sustainable practice.',
  },
]
...
const PLAN_PRACTICE: SummaryItem[] = [
  {
    ...
    description:
      'You have several warm prospects stalled at proposal stage. We keep those top of your weekly task list.',
  },
  {
    icon: <FollowupIcon />,
    title: 'Follow-ups are a strength',
    description: "Follow-up continue even when you're busy. We consider them a consistent part of your workflow.",
  },
  {
    icon: <SupportIcon />,
    title: 'Extra pre-meeting support for holistic conversations',
    description:
      'Holistic conversations are harder to prepare for. Nyla surfaces relevant facts and prep notes before each meeting.',
  },
  {
    icon: <EmailIcon />,
    title: 'Communication preference is email',
    description:
      'You prefer email over calls for most client communication. We default outreach drafts to email format.',
  },
]
