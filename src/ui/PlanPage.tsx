...
function OverviewSection() {
  ...
  useEffect(() => {
    if (!animateIn) {
      planOverviewLoaded = true
      return
    }
    const t = window.setTimeout(() => {
      planOverviewLoaded = true
      setRevealed(true)
    }, OVERVIEW_LOAD_PAUSE_MS)
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 40, alignItems: 'flex-start' }}>
        ...
        <motion.div
          ...
          transition={{
            duration: 0.8,
            delay: animateIn ? WINS_DELAY_S : 0,
            ease: EASE.settle as [number, number, number, number],
          }}
        >
          ...
          items={[
            {
              ...
              insight: {
                analysis: ['You’ve taken 3 days off in the last 90 — down from 8 over the same stretch last year.'],
