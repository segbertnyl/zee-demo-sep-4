...
export const Default: Story = {
  render: () => (
    <div style={{ maxWidth: 730 }}>
      <GoalRow icon={<ProtectIcon />} title="Protect time outside of work" />
    </div>
  ),
}
...
const GOALS = [
  {
    ...
    title: 'Protect time outside of work',
    description:
      "You said you haven't been able to take a vacation in a long time, and you're struggling to dedicate focused time to your family. We'll work on that.",
  },
  {
    icon: <GrowthIcon />,
    title: 'Grow my book of business',
    description:
      "You mentioned wanting to increase AUM by 20% over the next two years. We'll build a plan focused on referrals and prospecting cadence.",
  },
  {
    icon: <NetworkIcon />,
    title: 'Expand my professional network',
    description:
      "Strengthening your referral network and council relationships is a top priority. We'll identify key contacts and map out your outreach approach.",
  },
]
