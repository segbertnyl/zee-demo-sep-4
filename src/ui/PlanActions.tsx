...
export function PlanActions({ icon, title, items, nylaItems, onMakeChanges, className, nylaFill = 'var(--nyl-purple-025, #fbf5ff)' }: PlanActionsProps) {
            ...
            {nylaItems.slice(0, 10).map(item => {
              ...
              return (
                <div
                  ...
                  onKeyDown={!item.static ? (e) => { if (e.key === 'Enter' || e.key === ' ') toggleAdd(item.id) } : undefined}
                  style={{
                    display: 'flex',
                    gap: 16,
                ...
                >
                  <div style={{ paddingTop: 3, flexShrink: 0 }}>
                    {checked ? <CheckIcon /> : <PlusCircleIcon />}
                  </div>
                  <span style={{
                    fontFamily: 'var(--font-sans)',
                    fontSize: 16,
