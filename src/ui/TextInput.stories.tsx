...
export const AllVariants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 600 }}>
      <div>
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 500, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-body-muted)', marginBottom: 8 }}>Numeric — quantitative values</p>
        <TextInput variant="numeric" value="$ 47,000" />
      </div>
      <div>
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 500, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--text-body-muted)', marginBottom: 8 }}>Text — free-text strings</p>
