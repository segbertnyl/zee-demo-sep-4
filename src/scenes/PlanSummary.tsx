...
import { PlanActions } from '@/ui/PlanActions'
...
// Historical FYC accumulation — Mar to Today (Oct 16, x=461)
const CHART_ACTUAL = [
  { x: 0, value: 2 },
  { x: 143, value: 9 },
  { x: 286, value: 15 },
...
// Current pace projection — Oct 16 → Jun (won't reach goal)
...
// Plan projection — Oct 16 → Jun (reaches $47K goal)
...
export function PlanSummary({ advisorName = 'Sarah', onClose, onAccept }: PlanSummaryProps) {
  return (
    <div style={{ position: 'relative' }}>
      {/* Background as in-flow-height absolute — grows with content so bokeh covers full scroll distance */}
    ...
    <div style={{ position: 'relative', zIndex: 1, padding: '150px max(40px, calc((100% - 272px - 898px) * 0.65)) 120px max(312px, calc(272px + (100% - 272px - 898px) * 0.35))' }}>
        ...
        {/* ── Divider ── */}
        <div style={{ height: 1, background: 'rgba(255,255,255,0.15)', margin: '56px 0' }} />
        ...
        >
          ...
          {/* Width = content + PILL_AREA (243px) so flex math gives card the full content width.
              Pills still appear correctly on hover and overflow the content column to the right. */}
        ...
        >
          ...
          <button
            ...
            style={{
              flexShrink: 0,
              background: 'var(--nyl-purple-100)',
              color: 'var(--nyl-purple-800)',
              border: 'none',
              borderRadius: 4,
              padding: '12px 24px',
              fontFamily: 'var(--font-sans)',
