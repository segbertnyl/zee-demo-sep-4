                ...
                <div className="rounded-2xl border border-neutral-200 bg-white p-6">
                  ...
                  <section>
                    ...
                    <div className="mt-3 flex items-baseline gap-2">
                      ...
                      <p className="text-[12px] uppercase tracking-[0.18em] text-neutral-500">/ 100 · Peer Avg 64</p>
                    </div>
                    ...
                    <p className="mt-2 text-[13.5px] leading-[1.55] text-neutral-600">
                      The biggest lever right now: household penetration. Three referrals from existing households would
                      move the score by ~6 points.
                    </p>
                  </section>
                    ...
                    <div className="mt-4 grid grid-cols-12 items-center gap-3">
                      ...
                      <div className="col-span-6 flex flex-col items-end gap-1">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-[10.5px] uppercase tracking-[0.18em] text-neutral-500">12 wks</span>
                          <span className="text-[10.5px] font-medium text-[var(--nyl-orange-500)]">↓ 28%</span>
                        </div>
                      ...
                      <ul className="mt-3 flex flex-col gap-3">
                        {SUGGESTED_PLANS.map((p) => (
                          <li key={p.key} className="rounded-xl bg-[var(--nyl-blue-100)]/35 p-4">
                            ...
                            <p className="mt-2 text-[12.5px] leading-[1.55] text-neutral-700">{p.body}</p>
                            <p className="mt-2 text-[12.5px] italic leading-[1.55] text-neutral-600">{p.quote}</p>
                          </li>
                        ))}
                      </ul>
                    )}
                ...
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-12 rounded-2xl bg-[var(--nyl-blue-100)]/45 p-5 lg:col-span-8">
                    ...
                    <div className="mt-2 flex items-center gap-3">
                      <p className="text-[11.5px] text-neutral-700">Qualified only signals-ready clients</p>
...
function Pill({ children, tone }: { children: React.ReactNode; tone: 'orange' | 'green' | 'gray' }) {
  const cls =
    tone === 'orange'
  ...
  return <span className={['rounded-md px-2 py-0.5 text-[10px] font-medium', cls].join(' ')}>{children}</span>
}

function MetricCol({ k, v, pct, highlight }: { k: string; v: string; pct: string; highlight?: boolean }) {
  return (
    <div>
  ...
  return (
    <>
      <header className="mb-10 max-w-[820px]">
        ...
        <p className="mt-3 text-[14px] leading-[1.55] text-neutral-600">
          Established practices in your tenure band see their book grow fastest between year 6 and year 8. Here is where
          you stand and what tends to move first.
        </p>
      </header>
      ...
      <div className="grid grid-cols-12 gap-5 md:gap-7">
        <div className="col-span-12 lg:col-span-8">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <section className="mt-6">
              <p className="text-[10.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">Milestones</p>
              <ol className="mt-4 flex flex-col gap-4">
                <MilestoneRow
                  year="2020"
                  title="Joined New York Life"
                  body="Brooklyn office. First six months: foundational training, NY Life & Health license."
                />
                <MilestoneRow
                  year="2021"
                  title="Series 6 + 63"
                  body="Opened up mutual funds and 529s — first variable case six weeks later."
                />
                <MilestoneRow
                  year="2022"
                  title="Council Qualified"
                  body="$72K FYC. First full year above the office median."
                />
                <MilestoneRow
                  year="2023"
                  title="Series 7"
                  body="Began advisory case work. Average case value rose 38% within the year."
                />
                <MilestoneRow
                  year="2024"
                  title="Executive Council"
                  body="Top 12% by FYC. Started taking on family-office referrals."
                  active
                />
                <MilestoneRow
                  year="2025"
                  title="Chairman's Cabinet — on pace"
                  body="$92K FYC YTD. 4 cases away from Cabinet — fully achievable in current Q4."
                  next
                />
              </ol>
            </section>
        ...
        <div className="col-span-12 flex flex-col gap-4 lg:col-span-4">
          <div className="rounded-2xl bg-[var(--nyl-blue-100)]/45 p-5">
            ...
            <p className="mt-2 text-[12px] leading-snug text-neutral-700">
              By FYC among advisors at year 6 in NYC zone. Cohort growth rate is fastest at year 7 — your next 12 months
              are mathematically your highest-leverage window.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-[rgba(112,40,164,0.08)] p-5">
            ...
            <button
              ...
              onClick={() =>
                openCollab(
                  'Build a 12-month compounding plan from my journey — focus on multi-policy, gen-2 conversion, and one new center of influence.',
                )
              }
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-5">
            <p className="text-[10.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">Recognition log</p>
            <ul className="mt-3 flex flex-col gap-2 text-[12.5px] text-neutral-800">
              <li className="flex justify-between">
                <span>Council</span>
                <span className="text-neutral-500">2022, '23, '24</span>
              </li>
              <li className="flex justify-between">
              ...
              <li className="flex justify-between">
                <span>President's Round Table</span>
                <span className="text-neutral-500">2024</span>
              </li>
            </ul>
          </div>
...
function LearnTab({ openCollab }: { openCollab: (p?: string) => void }) {
  const recommended = [
    {
      ...
      duration: '22 min',
      prompt:
        'Walk me through a beneficiary-review conversation that opens a multi-policy door without feeling like a pitch.',
    },
    {
    ...
    },
    {
      ...
      duration: '28 min',
      prompt:
        'Build me a playbook for second-generation conversion — how to approach adult children of existing clients.',
    },
  ]
  ...
  const events = [
    ...
    {
      title: 'NYC Estate Planning Forum',
      when: 'March 22 · in person',
      tag: 'Suggested · 4 CE',
      tone: 'blue' as const,
    },
    {
      title: 'Mastering Discovery — live cohort',
      when: 'Starts April 7 · 5 weeks',
      tag: 'Suggested',
  ...
  return (
    <>
      <header className="mb-10 max-w-[820px]">
        ...
        <p className="mt-3 text-[14px] leading-[1.55] text-neutral-600">
          Modules picked from your gaps — not a generic catalog. Each one maps to a specific opportunity in your book.
        </p>
      </header>
      ...
      <div className="grid grid-cols-12 gap-5 md:gap-7">
        <div className="col-span-12 lg:col-span-8">
          ...
          <section className="mt-5 rounded-2xl border border-neutral-200 bg-white p-6">
            <p className="text-[10.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">In flight</p>
        ...
        <div className="col-span-12 flex flex-col gap-4 lg:col-span-4">
          <div className="rounded-2xl border border-neutral-200 bg-white p-5">
            <p className="text-[10.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">Upcoming events</p>
            <ul className="mt-3 flex flex-col gap-3">
              {events.map((e) => (
          ...
          <div className="rounded-2xl bg-[rgba(112,40,164,0.08)] p-5">
            ...
            <p className="mt-2 text-[12.5px] leading-snug text-neutral-800">
              Tell the agent what you want to get better at. It will pull the right module, prep a roleplay, or build a
              one-pager from the curriculum.
            </p>
            <button
              type="button"
              onClick={() =>
                openCollab(
                  'Teach me something I should know to grow my book this quarter — pick the most useful thing for my situation.',
                )
              }
              className="mt-4 rounded-md bg-[var(--nyl-blue-500)] px-3 py-1.5 text-[11px] font-medium text-white hover:bg-[var(--nyl-blue-600)]"
            >
...
function LicensesTab({ openCollab }: { openCollab: (p?: string) => void }) {
  const licenses = [
    ...
    {
      name: 'CT Life, Accident & Health',
      status: 'Pending',
      expires: 'Application submitted',
  ...
  return (
    <>
      <header className="mb-10 max-w-[820px]">
        ...
        <p className="mt-3 text-[14px] leading-[1.55] text-neutral-600">
          Everything that lets you sell, serve, and travel. The agent watches renewal windows and CE credits so nothing
          surprises you.
        </p>
      </header>
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white p-6">
            ...
            <ul className="mt-4 flex flex-col">
              {licenses.map((l) => (
                <li
                  key={l.name}
                  className="flex items-center justify-between gap-4 border-t border-neutral-100 py-3 first:border-t-0"
                >
                  <div className="min-w-0">
        ...
        <div className="col-span-12 flex flex-col gap-4 lg:col-span-4">
          <div className="rounded-2xl bg-[var(--nyl-blue-100)]/45 p-5">
            ...
            <p className="mt-3 text-[12px] leading-snug text-neutral-700">
              You are on pace. The NYC Estate Planning Forum (March 22) covers 4 more CEs in one evening if you want to
              bank them early.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-[var(--nyl-orange-100)]/60 p-5">
            ...
            <p className="mt-2 text-[12.5px] leading-snug text-neutral-800">
              Exam in 11 days. You have 6 prep modules left. Want the agent to schedule a 30-minute study block per day
              until exam day?
            </p>
            <button
              type="button"
              onClick={() =>
                openCollab(
                  'Block 30 minutes per day until June 14 for Series 65 study — pull the remaining prep modules into a sequence.',
                )
              }
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-5">
            <p className="text-[10.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">State coverage</p>
            <p className="mt-2 text-[12.5px] leading-snug text-neutral-700">
              ...
              <span className="font-medium text-neutral-900">NJ</span>. CT is in flight. 4 households in your book have
              second residences in <span className="font-medium text-neutral-900">FL</span> — a license there would
              unlock $11K of FYC currently sitting outside your reach.
            </p>
            <button
              type="button"
              onClick={() =>
                openCollab(
                  'Start a FL non-resident producer license application — list the steps, costs, and what the agent can prefill for me.',
                )
              }
...
function BrandTab({ openCollab }: { openCollab: (p?: string) => void }) {
  const channels = [
    {
      name: 'LinkedIn',
      meta: '847 connections · last post 3 weeks ago',
      cta: 'Draft my next post',
      tone: 'blue' as const,
      prompt:
        'Draft a LinkedIn post in my voice — thoughtful, conservative, story-first. Pick a recent case study I can talk about without naming the client.',
    },
    {
      name: 'Newsletter',
      meta: '342 subscribers · +12 this month · next send Friday',
      cta: "Draft this Friday's send",
      tone: 'purple' as const,
      prompt:
        "Draft this Friday's newsletter. Topic: what to do in the 30 days after a beneficiary event. 250 words. My voice.",
    },
    {
      name: 'Referral page',
      meta: 'nyl.com/marcus-tran · 22 visits this month',
      cta: 'Refresh the page copy',
      tone: 'green' as const,
      prompt:
        'Refresh my advisor referral page copy. Lean into Established practice, 6 years in, Brooklyn. Keep it short and human.',
    },
  ]

  const ideas = [
    {
      title: 'A short story about a beneficiary review',
      hook: 'You closed a multi-policy household last month doing exactly this. The arc writes itself.',
    },
    {
      title: 'Two myths about life insurance in your 30s',
      hook: 'Sam Bennett, Aanya Patel, and Jordan are all in this band. Educate without selling.',
    },
    {
      title: 'What a "household plan" actually means',
      hook: 'Demystify the language. Pull from your onboarding answers about how you describe your work.',
    },
  ]
  ...
  return (
    <>
      <header className="mb-10 max-w-[820px]">
        ...
        <p className="mt-3 text-[14px] leading-[1.55] text-neutral-600">
          Your voice is on file from onboarding. Anything the agent writes — posts, emails, page copy — sounds like you,
          not a template.
        </p>
      </header>
      ...
      <div className="grid grid-cols-12 gap-5 md:gap-7">
        <div className="col-span-12 lg:col-span-8">
          <section className="rounded-2xl border border-neutral-200 bg-white p-6">
            <p className="text-[10.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">Channels</p>
            <ul className="mt-4 flex flex-col gap-3">
              {channels.map((c) => (
                <li
                  key={c.name}
                  className="flex items-center justify-between gap-4 rounded-xl bg-[var(--nyl-blue-100)]/35 p-4"
                >
                  <div className="min-w-0">
        ...
        <div className="col-span-12 flex flex-col gap-4 lg:col-span-4">
          <div className="rounded-2xl bg-[rgba(112,40,164,0.08)] p-5">
            ...
            <div className="mt-3 flex flex-wrap gap-1.5">
              {['Thoughtful', 'Curious', 'Conservative', 'Story-first', 'No jargon'].map((t) => (
                <span key={t} className="rounded-md bg-white px-2 py-1 text-[11px] font-medium text-neutral-800">
                  {t}
                </span>
              ))}
            </div>
            <p className="mt-3 text-[12px] leading-snug text-neutral-700">
              Pulled from your onboarding answers. Adjust anytime — the agent re-tunes everything it writes for you.
            </p>
            <button
              type="button"
              onClick={() =>
                openCollab('Tune my brand voice — walk me through what to change about how the agent writes for me.')
              }
              className="mt-3 rounded-md border border-neutral-300 bg-white px-3 py-1.5 text-[11px] font-medium text-neutral-800 hover:bg-neutral-50"
            >
              Re-tune voice
          ...
          <div className="rounded-2xl bg-[var(--nyl-green-200)]/40 p-5">
            ...
            <p className="mt-2 text-[12px] leading-snug text-neutral-700">
              Across LinkedIn + newsletter. Up 41% vs. last month. Two clients mentioned a recent post when they walked
              in.
            </p>
          </div>
        </div>
    ...
    <li className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-10">
        <div className="flex items-baseline gap-2">
          ...
          {active && (
            <span className="rounded-md bg-[var(--nyl-blue-100)]/70 px-1.5 py-0.5 text-[10px] font-medium text-[var(--nyl-blue-600)]">
              Current
            </span>
          )}
          {next && (
            <span className="rounded-md bg-[var(--nyl-green-200)]/60 px-1.5 py-0.5 text-[10px] font-medium text-[var(--nyl-green-800)]">
              In reach
            </span>
          )}
        </div>
