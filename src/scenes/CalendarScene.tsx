...
const TODAY: Block[] = [
  ...
  { time: '9:00', label: 'Emma Clarke · annual review', meta: 'In-person · Astoria', kind: 'meeting', note: 'Drift toward the retirement-readiness frame.' },
  { time: '10:30', label: 'Patel household · annual review', meta: 'Virtual · 60 min', kind: 'meeting', note: 'Drill loaded. Aanya turns 18 in September.' },
  { time: '12:00', label: 'Open · lunch', kind: 'open' },
  { time: '1:00', label: 'Cesar Powell · reactivation call', meta: 'Phone · 20 min', kind: 'meeting', note: 'Lead with his daughter. Don\'t pitch.' },
      ...
      >
        {WEEK.map((w, i) => (
          ...
          >
            ...
            <p className="mt-2 font-serif text-[26px] leading-none tracking-tight text-neutral-900">
              {w.count}
            </p>
            <p className="mt-1 text-[11px] text-neutral-500">events</p>
            {w.label && (
              <p className="mt-2 text-[11.5px] font-medium text-[var(--nyl-blue-600)]">
                {w.label}
              </p>
            )}
          </button>
        ...
        {TODAY.map((b, i) => (
          ...
          >
            <div className="col-span-2 text-right">
              <p className="font-serif text-[20px] leading-none tracking-tight text-neutral-900">
                {b.time}
              </p>
            </div>
            <div className="col-span-7 min-w-0">
              ...
              {b.meta && (
                <p className="mt-0.5 text-[12px] uppercase tracking-[0.18em] text-neutral-400">
                  {b.meta}
                </p>
              )}
              {b.note && (
                <p className="mt-1.5 text-[12.5px] italic text-[var(--nyl-blue-600)]">
                  · {b.note}
                </p>
              )}
            </div>
