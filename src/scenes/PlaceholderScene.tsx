...
const SPECS: Record<string, Spec> = {
  clients: {
    ...
    body: "I keep this in the background. When something changes in a client's life, you'll see it on the briefing first. This page is where you go to dig in.",
    highlight: {
      title: 'What I would surface here',
      copy: 'Household profiles, signal feeds, relationship health, and the talk-tracks that have closed for advisors like you. Ask Nyla for any of it.',
    },
  },
  actives: {
    eyebrow: 'Actives',
    ...
    highlight: {
      ...
      copy: "Tom Anderson · day 11 in underwriting · the missing APS form is the only blocker. I would handle that, but you'd want to call him first.",
    },
  },
  prospects: {
    eyebrow: 'Prospects',
    headline: 'Where the next case lives.',
    body: 'Pipeline, nests, influence webs, and warm paths. The system you actually want runs upstream of your day — by the time you open this, the next move is already drafted.',
    highlight: {
      title: 'A move I would recommend',
      copy: 'Marcus Rosenthal is your strongest influencer this quarter — 4 mutuals are warm. I have a draft intro ready for any one of them.',
    },
  },
  business: {
    eyebrow: 'Business',
    headline: 'Your practice, on pace.',
    body: 'Production, council pacing, peer ranking. The numbers live here — but the math behind them lives in the briefing, where it can actually change a decision.',
    highlight: {
      title: 'Where you stand',
      copy: 'On pace for Eagle. 1.4 cases behind the cross-sell line. I queued two conversions and a workshop — that closes the gap.',
    },
  },
}
      ...
      <div className="grid flex-1 grid-cols-12 gap-8 px-8 pb-20 pt-16 md:px-12 md:pt-24">
        <div className="col-span-12 mx-auto w-full max-w-[820px]">
          ...
          >
            ...
            <p className="mt-3 max-w-[58ch] text-[15px] leading-[1.55] text-neutral-700">{spec.highlight.copy}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[12.5px] text-neutral-500">The full destination ships in the next iteration.</p>
          </motion.div>
        </div>
      </div>
    </section>
