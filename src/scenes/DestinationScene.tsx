...
const ACTIVES_SPEC: DestinationSpec = {
  ...
  content: {
    cases: {
      ...
      body: "Underwriting, service requests, applications. They move on their own. I'll pull one into your briefing the moment it actually needs your eye.",
      stats: [
      ...
      items: [
        {
          ...
          action: {
            label: 'Resend APS',
            prompt:
              'Walk me through resending the APS for Tom Anderson and draft a 10-minute call script to set expectations.',
          },
        },
        {
          id: 'maria',
          ...
          action: {
            label: 'Resend APS',
            prompt: 'Resend the APS for Maria Diaz and queue a Concierge audit so this stops happening.',
          },
        },
        {
          id: 'williams',
          ...
          action: {
            ...
            prompt: 'Draft a friendly signature reminder to Sarah Williams for her annuity rollover form.',
          },
        },
        {
          id: 'patel',
          ...
          action: {
            label: 'Open meeting pack',
            prompt:
              "Open Leela Patel's annual review pack — show me the cross-sell entry point and the talking points.",
          },
        },
        {
          id: 'clarke',
          ...
          action: {
            label: 'Open meeting pack',
            prompt:
              "Open Emma Clarke's annual review pack — surface the beneficiary catch + 401(k) rollover talking points.",
          },
        },
        {
          id: 'nguyen',
          ...
          action: {
            ...
            prompt: 'Resend the DocuSign reminder to Nguyen and draft a text confirmation.',
          },
        },
        {
          id: 'henderson',
          ...
          action: {
            ...
            prompt: 'Find me a 30-minute slot for Janet Henderson this week and load the flood-risk review pack.',
          },
        },
      ],
    },
    service: {
      ...
      body: 'Address changes, beneficiary updates, policy questions. Most resolve without you. The few that need a signature surface here.',
      stats: [
      ...
      items: [
        {
          ...
          action: {
            label: 'Send reminder',
            prompt: 'Send the e-signature reminder to Andrew Cooper for the beneficiary change.',
          },
        },
        {
          id: 'morales',
        ...
        },
        {
          ...
          action: {
            ...
            prompt:
              'Draft a beneficiary-review intro to Frances Carter — referred through Janet Henderson, household protection framing.',
          },
        },
      ],
    },
    tracking: {
      ...
      body: 'Submitted, in underwriting, issued, placed. Live status across your in-flight book — no refresh, no portal-hopping.',
      stats: [
      ...
      items: [
        ...
        },
        {
          ...
          action: {
            label: 'Open case',
            prompt: "Open Tom Anderson's case and walk me through the underwriting timeline.",
          },
        },
        {
          id: 'maria-tracking',
          ...
          action: {
            label: 'Open case',
            prompt: "Open Maria Diaz's case and walk me through what's blocking the WL conversion.",
          },
        },
        {
          id: 'okafor-tracking',
        ...
        },
        {
          ...
          action: {
            label: 'Send delivery note',
            prompt: "Draft the delivery note for Noor Yehya's new WL rider — congrats framing, low-pressure.",
          },
        },
        {
          id: 'reyes-tracking',
    ...
    followup: {
      ...
      body: 'Outstanding requirements, pending exams, unreturned calls. I queue the nudge; you decide whether it goes out as-is.',
      stats: [
      ...
      items: [
        {
          ...
          action: {
            label: 'Review & send',
            prompt: 'Review the J. Wong medical exam scheduling outreach and send it.',
          },
        },
        {
          id: 'fu-exam-2',
          ...
          action: {
            label: 'Review & send',
            prompt: 'Review the Derek Okafor medical exam scheduling outreach and send it.',
          },
        },
        {
          id: 'fu-call-tom',
          ...
          badge: { label: 'Urgent', tone: 'urgent' },
          action: {
            label: 'Open call script',
            prompt: 'Open the Tom Anderson expectations call script and walk me through the talking points.',
          },
        },
        {
          id: 'fu-rosenthal',
        ...
        },
        {
          ...
          action: {
            ...
            prompt: "Draft Emma Clarke's post-meeting 401(k) rollover follow-up — name the $210K, frame the next step.",
          },
        },
      ],
    },
...
const PROSPECTS_SPEC: DestinationSpec = {
  ...
  content: {
    discover: {
      ...
      body: 'Pipeline, nests, influence webs, and warm paths. By the time you open this, the next move is already drafted.',
      stats: [
      ...
      items: [
        {
          ...
          action: {
            label: 'Open fact-find pack',
            prompt: 'Open the Paul Reyes fact-finding pack — show me the discovery questions and household frame.',
          },
        },
        {
          id: 'jon-discover',
          ...
          action: {
            label: "Draft Jon's check-in",
            prompt: 'Draft a one-line check-in to Jon Owen — close the loop, no pressure.',
          },
        },
        {
          id: 'frances-discover',
          ...
          action: {
            label: 'Draft the intro',
            prompt: 'Draft a beneficiary-review intro to Frances Carter through Janet Henderson.',
          },
        },
        {
          id: 'rachel-discover',
          ...
          action: {
            label: 'Send the LTC primer',
            prompt: 'Draft a content-led LTC primer for Rachel Lim — no pitch, just open the door.',
          },
        },
        {
          id: 'wei-discover',
          ...
          action: {
            label: 'Draft curiosity opener',
            prompt: 'Draft a curiosity-led opener to Wei Chen — investigate the score lift without pitching.',
          },
        },
      ],
    },
    network: {
      ...
      body: 'Who knows whom, which clients refer, where the warm paths run. The graph updates as your book moves.',
      stats: [
      ...
      items: [
        {
          ...
          action: {
            label: 'Pull mutual list',
            prompt: 'Show me the 4 warm mutuals one degree out from Rosenthal — order by close probability.',
          },
        },
        {
          id: 'patel-circle',
        ...
        },
        {
          ...
          action: {
            label: 'Open household map',
            prompt: 'Walk me through the Henderson household map — show me everyone Janet could refer.',
          },
        },
        {
          id: 'sam-bennett-coi',
          ...
          action: {
            ...
            prompt: 'Help me plant a referral seat at my next Sam Bennett warmth call.',
          },
        },
      ],
    },
    events: {
      ...
      body: 'Chambers, workshops, and community moments where your next clients already gather — sequenced to your week.',
      stats: [
      ...
      items: [
        {
          ...
          action: {
            ...
            prompt:
              'Open my run sheet for the Astoria business breakfast — show me the 3 prospects and prep the intros.',
          },
        },
        {
          id: 'queens-chamber',
          ...
          action: {
            label: 'Draft the goals',
            prompt: 'Set 2-3 goals for the Queens chamber networking event — who to meet, how to introduce myself.',
          },
        },
        {
          id: 'linkedin-women',
    ...
    outreach: {
      ...
      body: 'Intros, re-engagements, birthday notes. By the time you open this, the message is written and waiting for your voice.',
      stats: [
        { label: 'Drafted overnight', value: '5', note: 'Review and send', tone: 'ready' },
      ...
      items: [
        {
          ...
          action: {
            label: 'Review & send',
            prompt: "Review Helena Garcia's pre-60 reconnection message — confirm tone and send.",
          },
        },
        {
          id: 'janet-outreach',
          ...
          action: {
            label: 'Review & send',
            prompt: "Review Janet Henderson's coverage-review outreach and send it with a calendar link.",
          },
        },
        {
          id: 'jon-outreach',
        ...
        },
        {
          ...
          action: {
            label: 'Review & send',
            prompt: 'Review the Chloe Abrams 45th-birthday milestone outreach and send it.',
          },
        },
        {
          id: 'no-touch-90',
          ...
          action: {
            ...
            prompt: 'Walk me through the 14-household no-touch-90 reactivation batch — let me approve each.',
          },
        },
      ],
    },
        ...
        <div className="col-span-12 w-full max-w-[1100px]">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mt-5 max-w-[64ch] text-[14.5px] leading-[1.55] text-neutral-600">{active.body}</p>
              ...
              {active.card && (
                <div className="mt-8 rounded-2xl bg-white p-6 shadow-[0_24px_60px_-30px_rgba(0,10,98,0.18)]">
                  ...
                  <p className="mt-3 max-w-[58ch] text-[15px] leading-[1.55] text-neutral-700">{active.card.copy}</p>
                </div>
              )}
            </motion.div>
          </AnimatePresence>
...
function StatCard({ stat }: { stat: StatTile }) {
  ...
  return (
    <div className="rounded-xl border border-neutral-200 bg-white p-4">
      ...
      <p
        className={['mt-2 font-serif text-[24px] leading-none tracking-tight', accent].join(' ')}
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          <p className="text-[15px] font-semibold text-neutral-900">
            {titleClickable ? (
              <button type="button" onClick={onClient} className="text-[var(--nyl-blue-500)] hover:underline">
                {item.title}
              </button>
            ) : (
              item.title
        ...
        <div className="flex shrink-0 flex-col items-end gap-2">
          {item.badge && tone && (
            <span
              className={[
                'inline-flex rounded-md px-2 py-0.5 text-[10.5px] font-medium uppercase tracking-[0.18em]',
                tone.bg,
                tone.text,
              ].join(' ')}
            >
...
export function DestinationTopBar({
  ...
  return (
    <div className="sticky top-0 z-30 flex items-center justify-between gap-6 border-b border-neutral-200 bg-white/85 px-8 py-3 backdrop-blur-sm md:px-12">
      <p className="text-[11.5px] font-medium uppercase tracking-[0.22em] text-neutral-500">{eyebrow}</p>
