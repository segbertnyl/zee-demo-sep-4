...
const GOALS = [
  ...
  },
  {
    ...
    description:
      "You mentioned wanting to move beyond pure protection into a full financial planning practice. This shapes how we'll prioritize your book.",
  },
  {
    icon: <SuccessionIcon />,
    title: 'Take on clients from a retiring agent',
    description:
      "You flagged interest in acquiring a retiring colleague's book. We'll build outreach and onboarding steps into your plan.",
  },
  {
    icon: <NetworkIcon />,
    title: 'Expand your network of communities',
    description:
      "Growing your referral network through community engagement is a high-leverage activity we'll build regular time for.",
  },
  {
    icon: <ProtectIcon />,
    title: 'Protect time outside of work',
    description:
      'You said work has been bleeding into personal time. Setting hard boundaries is part of building a sustainable practice.',
  },
]
...
const PRACTICE = [
  {
    ...
    description:
      "You have several warm prospects stalled at proposal stage. We'll keep those top of your weekly task list.",
  },
  {
    icon: <FollowupIcon />,
  ...
  },
  {
    ...
    description:
      'You find holistic conversations harder to prepare for. Nyla will surface relevant facts and prep notes before each meeting.',
  },
  {
    icon: <EmailIcon />,
    title: 'Communication preference is email',
    description:
      "You prefer email over calls for most client communication. We'll default outreach drafts to email format.",
  },
]
                  ...
                  return (
                    ...
                    >
                      <GoalRow
                        ...
                        selected={expandedKey === key}
                        onRemove={() => {
                          setPractice((p) => p.filter((_, j) => j !== i))
                          setExpandedKey(null)
                        }}
                      />
                    </motion.div>
