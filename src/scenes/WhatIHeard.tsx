  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#wh-fyc)">
        <path d="M11.8003 10.9C9.53031 10.31 8.80031 9.7 8.80031 8.75C8.80031 7.66 9.81031 6.9 11.5003 6.9C13.2803 6.9 13.9403 7.75 14.0003 9H16.2103C16.1403 7.28 15.0903 5.7 13.0003 5.19V3H10.0003V5.16C8.06031 5.58 6.50031 6.84 6.50031 8.77C6.50031 11.08 8.41031 12.23 11.2003 12.9C13.7003 13.5 14.2003 14.38 14.2003 15.31C14.2003 16 13.7103 17.1 11.5003 17.1C9.44031 17.1 8.63031 16.18 8.52031 15H6.32031C6.44031 17.19 8.08031 18.42 10.0003 18.83V21H13.0003V18.85C14.9503 18.48 16.5003 17.35 16.5003 15.3C16.5003 12.46 14.0703 11.49 11.8003 10.9Z" fill="#7028A4"/>
      </g>
      <defs><clipPath id="wh-fyc"><rect width="24" height="24" fill="white"/></clipPath></defs>
    </svg>
  )
}
...
function ProtectIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs><clipPath id="wh-protect"><rect width="24" height="24" fill="white"/></clipPath></defs>
    </svg>
  )
}
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#wh-client)">
        <path d="M18.39 14.56C16.71 13.7 14.53 13 12 13C9.47 13 7.29 13.7 5.61 14.56C4.61 15.07 4 16.1 4 17.22V20H20V17.22C20 16.1 19.39 15.07 18.39 14.56ZM18 18H6V17.22C6 16.84 6.2 16.5 6.52 16.34C7.71 15.73 9.63 15 12 15C14.37 15 16.29 15.73 17.48 16.34C17.8 16.5 18 16.84 18 17.22V18Z" fill="#7028A4"/>
        <path d="M12 12C14.21 12 16 10.21 16 8C16 6.63 16 4.5 16 4.5C16 3.67 15.33 3 14.5 3C13.98 3 13.52 3.27 13.25 3.67C12.98 3.27 12.52 3 12 3C11.48 3 11.02 3.27 10.75 3.67C10.48 3.27 10.02 3 9.5 3C8.67 3 8 3.67 8 4.5C8 4.5 8 6.62 8 8C8 10.21 9.79 12 12 12ZM10 5.5H14V8C14 9.1 13.1 10 12 10C10.9 10 10 9.1 10 8V5.5Z" fill="#7028A4"/>
      </g>
      <defs><clipPath id="wh-client"><rect width="24" height="24" fill="white"/></clipPath></defs>
    </svg>
  )
}
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#wh-followup)">
        <path d="M4 4H20V16H5.17L4 17.17V4ZM4 2C2.9 2 2.01 2.9 2.01 4L2 22L6 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2H4ZM6 12H14V14H6V12ZM6 9H18V11H6V9ZM6 6H18V8H6V6Z" fill="#7028A4"/>
      </g>
      <defs><clipPath id="wh-followup"><rect width="24" height="24" fill="white"/></clipPath></defs>
    </svg>
  )
}
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#wh-email)">
        <path d="M22 6C22 4.9 21.1 4 20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6ZM20 6L12 11L4 6H20ZM20 18H4V8L12 13L20 8V18Z" fill="#7028A4"/>
      </g>
      <defs><clipPath id="wh-email"><rect width="24" height="24" fill="white"/></clipPath></defs>
    </svg>
  )
}
...
const GOALS = [
  {
    icon: <FYCIcon />,
    title: 'Earn $175,000 in FYC',
    description: "Based on your current pace and last year's performance, hitting $175k in FYC is an achievable target.",
  },
  {
    icon: <CouncilIcon />,
    title: "Reach President's Council",
    description: "You've been close for two years running. This year's plan prioritizes the case volume and mix needed to qualify.",
  },
  {
    icon: <GrowthIcon />,
    title: 'Become a true holistic financial advisor',
    description: "You mentioned wanting to move beyond pure protection into a full financial planning practice. This shapes how we'll prioritize your book.",
  },
  {
    icon: <SuccessionIcon />,
    title: 'Take on clients from a retiring agent',
    description: "You flagged interest in acquiring a retiring colleague's book. We'll build outreach and onboarding steps into your plan.",
  },
  {
    icon: <NetworkIcon />,
    title: 'Expand your network of communities',
    description: "Growing your referral network through community engagement is a high-leverage activity we'll build regular time for.",
  },
  {
    icon: <ProtectIcon />,
    title: 'Protect time outside of work',
    description: "You said work has been bleeding into personal time. Setting hard boundaries is part of building a sustainable practice.",
  },
]
...
const PRACTICE = [
  {
    icon: <ClientIcon />,
    title: 'Prioritize clients already in the pipeline',
    description: "You have several warm prospects stalled at proposal stage. We'll keep those top of your weekly task list.",
  },
  {
    icon: <FollowupIcon />,
    title: 'Follow-ups are a strength',
    description: "You stay on top of follow-ups even when you're busy. We'll build space for this into your workflow.",
  },
  {
    icon: <SupportIcon />,
    title: 'Extra pre-meeting support desired for holistic conversations',
    description: "You find holistic conversations harder to prepare for. Nyla will surface relevant facts and prep notes before each meeting.",
  },
  {
    icon: <EmailIcon />,
    title: 'Communication preference is email',
    description: "You prefer email over calls for most client communication. We'll default outreach drafts to email format.",
  },
]
...
export function WhatIHeard({ onContinue }: WhatIHeardProps) {
  ...
  return (
    <div style={{ position: 'relative', height: '100%', boxSizing: 'border-box' }}>
      ...
      <motion.h1
        ...
        initial="hidden"
        animate="visible"
        transition={{ duration: DURATION.deliberate, ease: EASE.settle as [number, number, number, number], delay: 0.5 }}
        style={{
              ...
              return (
                ...
                >
                  <GoalRow
                    ...
                    onRemove={() => { setGoals(g => g.filter((_, j) => j !== i)); setExpandedKey(null) }}
                  />
                </motion.div>
              )
            })}
              ...
              return (
                ...
                >
                  <GoalRow
                    ...
                    selected={expandedKey === key}
                    onRemove={() => { setPractice(p => p.filter((_, j) => j !== i)); setExpandedKey(null) }}
                  />
                </motion.div>
              )
            })}
