...
export default {
  title: 'Design System / Icons / Goal icons',
...
function IconTile({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    ...
    >
      {children}
      <span
        style={{ fontFamily: 'var(--font-sans)', fontSize: 11, color: 'var(--text-body-muted)', textAlign: 'center' }}
      >
        {label}
      </span>
    </div>
...
export const GoalIcons: StoryObj = {
  name: 'Goal icons',
  render: () => (
    <IconGrid>
      <IconTile label="client">
      ...
      <IconTile label="followup">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip-followup)">
            <path
      ...
      <IconTile label="protect">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip-protect)">
            <path
      ...
      <IconTile label="succession">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip-succession)">
            <path
