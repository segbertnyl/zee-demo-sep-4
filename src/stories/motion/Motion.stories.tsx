  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 12 }}>
        <div>
          <span
            style={{ fontFamily: 'var(--font-mono)', fontSize: 13, fontWeight: 600, color: 'var(--text-headline)' }}
          >
            {name}
          </span>
          {aliases && aliases.length > 0 && (
            <span
              style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--text-body-muted)', marginLeft: 8 }}
            >
              also: {aliases.join(', ')}
            </span>
          )}
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, fontWeight: 600, color: 'var(--text-headline)' }}>
          {name}
        </span>
        <ReplayButton onClick={replay} />
      </div>
    ...
    <div style={{ maxWidth: 760, display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      >
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: 12, color: 'var(--nyl-gray-800)', margin: 0 }}>
          ...
          <code style={{ fontFamily: 'var(--font-mono)', fontSize: 11 }}>EASE_SETTLE</code>,{' '}
          <code style={{ fontFamily: 'var(--font-mono)', fontSize: 11 }}>HOUSE_EASE</code>, and{' '}
          <code style={{ fontFamily: 'var(--font-mono)', fontSize: 11 }}>EASE</code> are the same curve defined four
          times across the codebase. Consider extracting to a shared{' '}
          <code style={{ fontFamily: 'var(--font-mono)', fontSize: 11 }}>src/motion.ts</code> constants file.
        </p>
      </div>
          ...
          demo={(key) => (
            <motion.div
              ...
              style={{
                ...
                background: 'var(--bg-surface-elevated)',
                border: '1px solid var(--border-subtle)',
                boxShadow: '0 24px 60px -20px rgba(0,10,98,0.18)',
                fontFamily: 'var(--font-sans)',
                fontSize: 13,
                color: 'var(--text-body)',
              }}
        ...
        <PatternDemo
          ...
          demo={(key) => (
            <motion.div
              ...
              transition={{
                duration: NYLA.glow.rampIn * 2 + NYLA.settle.holdMs / 1000,
                times: [0, 0.3, 1],
                ease: EASE.settle,
              }}
              style={{
            ...
            >
              <motion.span
                ...
                style={{
                  ...
                  justifyContent: 'center',
                  borderRadius: '50%',
                  background: 'var(--badge-opportunity)',
                  color: '#fff',
                  fontSize: 13,
                }}
              >
